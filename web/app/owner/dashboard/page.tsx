    ...
    <div className="min-h-dvh w-full bg-background">
      <div className="bg-brand-700 px-5 sm:px-8 pt-8 pb-7">
        <div className="max-w-5xl mx-auto">
          ...
          {/* 이미 등록을 마친 사장님이 자료를 더 올리거나 검수하러 들어오는 길 */}
          <div className="flex items-center gap-2 mb-5">
            <Link
              href="/owner/upload"
              className="inline-flex items-center gap-1.5 rounded-full bg-white px-4 h-10 text-sm font-bold text-brand-700 hover:bg-white/90 transition-colors"
            >
              <span aria-hidden>＋</span> 자료 추가
            </Link>
            <Link
              href="/owner/preview"
              className="inline-flex items-center rounded-full border border-white/40 px-4 h-10 text-sm font-bold text-white hover:bg-white/10 transition-colors"
            >
              학습 미리보기
            </Link>
          </div>
