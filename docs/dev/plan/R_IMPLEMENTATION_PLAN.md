...
2026-09-19 최신: [일반 의미 런타임](../review/R_GENERAL_RUNTIME_20260919.md) 기본 OFF 구현. 아래의 일반화 경로 미구현 기록은 이전 상태다. 현재 미등록 표현의 모델 해석/별도 검증/서버 검사/저장은 연결됐으며 실제 품질 인수·활성화는 대기다. 명확화는 승인 temperature/size 선택지로 제한한다.
