...
현재 목표는 CP-00A~C 원가 계측 선행(CP-01 계약 오류/보안 병행) → CP-02~03 계약·fixture 동결 → W0~W5 / R0~R5 병렬 + CP-04~05 → J0~J3이다. C0 계획의 비용 범위·사용량 처리 방향은 확정됐으며 실제 계측·타입 보강·공용 fixture·DB/API·평가 인수는 남아 있다. 원장 선저장·불변 승인 snapshot·참조 renderer·chat v2 런타임은 계획이며 문서 동기화로 구현된 것이 아니다. 상세 현황은 MVP 22절, 완료 조건은 TODO를 따른다.
