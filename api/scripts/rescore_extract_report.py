...
from app.team.extraction import (ExtractionReport, SCORER_VERSION, aggregate, applicability,
                                normalize, variant_axis, match_fact, match_fact_in_ledger, score_output)
...
def rescore(data):
    ...
    for fact in truth:
        ...
        report.add(fact,match_fact(fact,cards,require_variant=needs_variant),
